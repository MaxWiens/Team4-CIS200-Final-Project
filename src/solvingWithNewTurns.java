...
public class solvingWithNewTurns {
	...
	public void solve(char[][][] sides) {
		part2(sides);// finding white corners
	...
	public char[][][] part2(char[][][] atP2){//part 2
		int i = 0;
		while(i < 10) {
		if((atP2[1][0][2] == atP2[0][1][1]) || (atP2[3][0][0] == atP2[0][1][1]) ||
			(atP2[0][2][2] == atP2[0][1][1])) {
			//rotate(3, false);
			//rotate(5, false);
			//rotate(3, true);
		}
		...
		while(!correct) {
		if((atP2[1][0][2] == atP2[1][1][1] && atP2[3][0][0] == atP2[3][1][1] && atP2[0][2][2] == atP2[0][1][1]) &&
			(atP2[1][0][0] == atP2[1][1][1] && atP2[2][0][2] == atP2[2][1][1] && atP2[0][2][0] == atP2[0][1][1]) &&
			(atP2[2][0][0] == atP2[2][1][1] && atP2[4][0][2] == atP2[4][1][1] && atP2[0][0][0] == atP2[0][1][1]) &&
			(atP2[3][0][2] == atP2[3][1][1] && atP2[4][0][0] == atP2[4][1][1] && atP2[0][0][2] == atP2[0][1][1])){
			correct = true;
		}
	
		if((atP2[1][2][2] == atP2[1][1][1]) && (atP2[3][2][0] == atP2[0][1][1]) &&
			((atP2[5][0][2] == atP2[3][1][1]))) {
			//rotate(3, false);
		...
		else if((atP2[1][2][2] == atP2[3][1][1]) && (atP2[3][2][0] == atP2[1][1][1]) &&
				((atP2[5][0][2] == atP2[0][1][1]))){
			//3 times
			//rotate(3, false);
			//instructions.add(new SolveInstruction(copyState(sides), "Turn the right Side counter clockwise"));
			//rotate(5, false);
		...
		else if((atP2[1][2][2] == atP2[0][1][1]) && (atP2[3][2][0] == atP2[3][1][1]) &&
				((atP2[5][0][2] == atP2[1][1][1]))) {
			//rotate(3, false);
			//instructions.add(new SolveInstruction(copyState(sides), "Turn the right Side counter clockwise"));
			//rotate(5, false);
			//instructions.add(new SolveInstruction(copyState(sides), "Turn the bottom Side counter clockwise"));
